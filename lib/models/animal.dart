...
class Animal {
  ...
  static final List<Animal> todosAnimais = [
    ...
    Animal(chip: 1113, fullName: "Gouda Coelho", age:8, sterilized:true, gender: 0, legalOwner: "Hugo Coelho", allergies:"nenhumas", size:"Giant", behavior: "um bebe grande", breed: "indefenido", species: "dog", numeroDePasseiosDados: 0, asGodFather: true),
